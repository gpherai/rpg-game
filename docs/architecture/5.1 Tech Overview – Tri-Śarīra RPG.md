...
- **Scene-based**: een centrale `SceneManager` stuurt welke Scene actief is (`MainMenu`, `OverworldScene`, `BattleScene`, `DialogueScene`, etc.).
...
- `config/default.toml` – standaardwaarden.  
